"""Incremental lattice reference direction generation."""
...
def check_n_points(n_points, n_dim):
    """Return n_partitions or a numeric value associated with the exception message."""
    if n_dim == 1:
        return [0]

    I = n_dim * np.eye(n_dim)  # noqa: E741
    W = np.zeros((1, n_dim))
    edgeW = W
    i = 0
