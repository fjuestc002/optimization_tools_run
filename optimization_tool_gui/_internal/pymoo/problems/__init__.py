"""Test problems for optimization including single- and multi-objective benchmarks."""


def get_problem(name: str, *args, **kwargs):
    """Get an optimization problem by name.

    Args:
        name: Problem name (case-insensitive).
        *args: Positional arguments for problem instantiation.
        **kwargs: Keyword arguments for problem instantiation.

    Returns:
        Instantiated problem object.

    Raises:
        Exception: If problem name is not found.
    """
    name = name.lower()
