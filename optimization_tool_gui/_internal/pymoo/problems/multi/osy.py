...
class OSY(Problem):
    def __init__(self) -> None:
        ...
        self.xl: np.ndarray = np.array([0.0, 0.0, 1.0, 0.0, 1.0, 0.0])
        self.xu: np.ndarray = np.array([10.0, 10.0, 5.0, 6.0, 5.0, 10.0])
    ...
    def _calc_pareto_front(self) -> np.ndarray:  # type: ignore[return-value]
        return Remote.get_instance().load("pymoo", "pf", "osy.pf")  # type: ignore[return-value]
