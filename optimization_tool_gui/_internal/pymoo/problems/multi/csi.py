...
class CSI(Problem):
    def __init__(self) -> None:
        xl: np.ndarray = np.array([0.500, 0.450, 0.500, 0.500, 0.875, 0.400, 0.400])
        xu: np.ndarray = np.array([1.500, 1.350, 1.500, 1.500, 2.625, 1.200, 1.200])
