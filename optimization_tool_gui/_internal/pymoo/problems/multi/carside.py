"""Carside multi-objective optimization problem."""
...
class Carside(Problem):
    """Car side impact problem: multi-objective design optimization.

    A 7-variable, 3-objective optimization problem with 10 inequality constraints.
    Involves design of car side structure to minimize weight, acceleration, and
    intrusion while satisfying safety constraints.
    """

    def __init__(self):
        """Initialize Carside problem with 7 variables, 3 objectives, and 10 constraints."""
    ...
    def _evaluate(self, x, out, *args, **kwargs):
        """Evaluate Carside problem objectives and constraints."""
    ...
    def _calc_pareto_front(self, *args, **kwargs):
        """Load reference Pareto front from remote data."""
