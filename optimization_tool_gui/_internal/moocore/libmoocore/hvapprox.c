                     ...
                     const boolvec * restrict maximise)
{
    ...
    */
    ...
    for (i = 0, j = 0; i < npoints; i++) {
        double * restrict dst = points + j * dim;
        const double * restrict src = data + i * dim;
        dimension_t k;
        for (k = 0; k < dim; k++) {
            dst[k] = maximise[k] ? (src[k] - ref[k]) : (ref[k] - src[k]);
...
static const long double sphere_area_div_2_pow_d[] = {
    0.0L, // d = 0, value = 0.0
    1.0L, // d = 1, value = 1.0
    0x1.921fb54442d18469898cc51701b839a252049c1115p+0L, // d = 2, value = 1.5707963267948966
    0x1.921fb54442d18469898cc51701b839a252049c1115p+0L, // d = 3, value = 1.5707963267948966
    0x1.3bd3cc9be45de5a4adc4d9b30118358e10acd47fc2p+0L, // d = 4, value = 1.2337005501361697
    0x1.a51a6625307d3230e7b1224401759cbd6b911b5502p-1L, // d = 5, value = 0.8224670334241132
    0x1.f019b59389d7c1e019558e5380d6d8733503c4a497p-2L, // d = 6, value = 0.4844730731296847
    0x1.08963eb51650efeefc71e581de507370a4cecf46b7p-2L, // d = 7, value = 0.2583856390024985
    0x1.03c1f081b5ac3b353301e00faeda2538125c8c3b59p-3L, // d = 8, value = 0.12683475395052402
    0x1.dafc3b70d72c4f02316283c4e7f54b5f3784a8a709p-5L, // d = 9, value = 0.05798160180595383
    0x1.9806b8153159a46d9e0255c5898bcf370eee57846p-6L, // d = 10, value = 0.0249039457019272
    0x1.4b9a2f342b5b8b51c57e3d94590728cf4916387f16p-7L, // d = 11, value = 0.010119698570941848
    0x1.005ed5ead8ffb7d3fbc24f22cec8451f00764b8e16p-8L, // d = 12, value = 0.00391190264312868
...
static const long double sphere_area_div_2_pow_d_times_d[] = {
    0.0L, // d = 0, value = 0.0
    1.0L, // d = 1, value = 1.0
    0x1.921fb54442d18469898cc51701b839a252049c1115p-1L, // d = 2, value = 0.7853981633974483
    0x1.0c152382d73658465bb32e0f567ad116e158680b63p-1L, // d = 3, value = 0.5235987755982989
    0x1.3bd3cc9be45de5a4adc4d9b30118358e10acd47fc2p-2L, // d = 4, value = 0.30842513753404244
    0x1.50e1eb50f3975b5a52f41b699ac47d64560daf7735p-3L, // d = 5, value = 0.16449340668482265
    0x1.4abbce625be52beabb8e5ee255e4904cce02831865p-4L, // d = 6, value = 0.08074551218828079
    0x1.2e6290cef4eec91120822add905bf1a54ea33607acp-5L, // d = 7, value = 0.036912234143214075
    0x1.03c1f081b5ac3b353301e00faeda2538125c8c3b59p-6L, // d = 8, value = 0.015854344243815502
    0x1.a6358a2b69ee7f1e64c958af0712eda9f875eb3f25p-8L, // d = 9, value = 0.006442400200661537
    0x1.466bc6775aae1d247e68449e07a30c2c0bf1df9d1ap-9L, // d = 10, value = 0.0024903945701927202
...
{
    ASSUME(1 <= dim && dim <= MOOCORE_HVAPPROX_DIMENSION_MAX);
    ...
    for (dimension_t k = 1; k < dim; k++) {
        long double temp = fabsl(2 * cosl(2 * M_PIl * k / p));
        temp = fractl(temp);
...
static long double *
Rphi_init(dimension_t dim)
{
    ASSUME(1 <= dim && dim <= MOOCORE_HVAPPROX_DIMENSION_MAX);
    // Generated by rphi_seq.py
    static const long double recip_phi_d[] = {
        0x1.3c6ef372fe94f82be73980c0b9db9068p-1L, // d = 1, value = 0.6180339887498949
        0x1.827f5352054c651e869fee365b2ee496p-1L, // d = 2, value = 0.7548776662466927
        0x1.a36a9465a325da073fb954fadd3bfc1ep-1L, // d = 3, value = 0.8191725133961645
        0x1.b69e1722eb5c42ca89cf1feab545b792p-1L, // d = 4, value = 0.8566748838545029
        0x1.c33603553a858c666b0ed20913d97206p-1L, // d = 5, value = 0.8812714616335696
        0x1.cc1c56e456a75dd75bdfb98e3acc2a36p-1L, // d = 6, value = 0.8986537126286993
        0x1.d2bc3ba2fa6b001b3da7836af99d4a46p-1L, // d = 7, value = 0.9115923534820549
        0x1.d7dbddb3b007902ac66a769dcced40e8p-1L, // d = 8, value = 0.921599319633983
        0x1.dbf09da830ac4b5b78a071d357d8f69p-1L, // d = 9, value = 0.9295701282320229
        0x1.df447355bfe101fe8e061906ef910892p-1L, // d = 10, value = 0.9360691110777584
        0x1.e2084e4125eaf8bad4252c318d09f94p-1L, // d = 11, value = 0.9414696173216353
        0x1.e45dd9ec23b286dcd71a526afbf60b0cp-1L, // d = 12, value = 0.9460285282856136
        0x1.e65d03e6c54d3fb86d0f3719cc312b34p-1L, // d = 13, value = 0.9499283999636199
        0x1.e817452aaafd610e9fb913ef9fd3d1f6p-1L, // d = 14, value = 0.9533025374016642
        0x1.e999ac4fac81923526609aa9500c8714p-1L, // d = 15, value = 0.956250557637989
        0x1.eaee2d784c7a2a12c3f8fb9f3e0c845ap-1L, // d = 16, value = 0.9588484010075614
        0x1.ec1c812639bb4fcaf0c77ea1b928ce8p-1L, // d = 17, value = 0.9611549719964986
        0x1.ed2abc080172300d8c99d6b7243efe06p-1L, // d = 18, value = 0.9632166633389015
        0x1.ee1db8d5714f2db5cac4578507e8ea5ap-1L, // d = 19, value = 0.9650705109167163
        0x1.eef963ac826a7c42c01de9f69371432p-1L, // d = 20, value = 0.9667464397509393
        0x1.efc0f0b70647ebf090e01491ac5f7e7ep-1L, // d = 21, value = 0.9682688926142332
        0x1.f0770473779aa3295949acf33d7863dp-1L, // d = 22, value = 0.9696580306006599
        0x1.f11dd1d928f6e36afbb5b7bfaa5051cp-1L, // d = 23, value = 0.9709306314075385
        0x1.f1b73133ed1bbcb86ce969d55f87f296p-1L, // d = 24, value = 0.9721007705580216
        0x1.f244b1b08b20119afb70f95f23ee065ap-1L, // d = 25, value = 0.9731803443915511
        0x1.f2c7a6fc9f4badc4ce6165ec81c87cap-1L, // d = 26, value = 0.9741794761063355
        0x1.f34133f695ffb8b5ffd1bd93c5c298d2p-1L, // d = 27, value = 0.9751068342693539
        0x1.f3b253244f82923c4b970872f0f7dfeap-1L, // d = 28, value = 0.9759698850464292
        0x1.f41bdd76057468dfbf6d17f30fb8b3b6p-1L, // d = 29, value = 0.97677509370508
        0x1.f47e8fb85ff198ad0ba7200a8f43f12cp-1L, // d = 30, value = 0.9775280869070884
        0x1.f4db0effcb296f3423b8035a7f4efee8p-1L, // d = 31, value = 0.9782337844131516
    };

    long double * alpha = malloc(sizeof(*alpha) * dim);
    alpha[0] = recip_phi_d[dim - 1];
    for (dimension_t d = 1; d < dim; d++)
        alpha[d] = alpha[d-1] * recip_phi_d[dim - 1]; // Same as pow(recip_phi_d[dim - 1], d)
    return alpha;
}
...
Rphi_next(double * restrict u, dimension_t dim, const long double * restrict alpha)
{
    ...
    */
    ...
    /* When a and n are integers and n > 0, then fract(a / 2^n) = r / 2^n,
       ...
       compute r = a & (2^n - 1), so fract(a / 2^n) = a & (2^n - 1).

       Then, if a = (u + alpha)*2^n, then:

          frac(u + alpha) = ((u + alpha)*2^n) & (2^n - 1)) / 2^n

       For example, with n=64:

         uint64_t ui = (uint64_t)(u[d] * exp2(64));
         uint64_t alphai = (uint64_t)((double)alpha[d] * exp2(64));
         ui = (uint64_t)(ui + alphai) & ((uint64_t)-1);
         u[d] = ((double)ui) * exp2(-64);

       If you need integers, and assuming u[d] is initialized with an integer,
       the above simplifies to:

         u[d] = (uint64_t)(u[d] + alphai) & ((uint64_t)-1);
    */
}
...
/**
   Modified version of the efficient mapping proposed by Fang and Wang (1994).
   See Sec 4.2.1
   https://erho.weebly.com/uploads/2/7/8/4/27841631/computation_of_multivariate_normal_and_t_probabilities.pdf
   Alan Genz, Frank Bretz. Computation of Multivariate Normal and t
   Probabilities.

   This version directly maps to the positive orthant of the hypersphere.  For
   details, see López-Ibáñez (2026).
*/
static void
fang_wang_efficient_mapping_plus(double * restrict w, dimension_t dim,
                                 const double * restrict u)
{
    /* FIXME: This function is not vectorized by GCC:
       - [ ] It should be possible to vectorize sin(M_PI_2 * u[l]) and cos(M_PI_2 * u[l]).
       - [ ] GCC introduces if (1. - tmp * tmp >= 0) else within the loop,
             which prevents vectorization.
     */
    ASSUME(2 <= dim && dim <= MOOCORE_HVAPPROX_DIMENSION_MAX);
    double product = 1.;
    const dimension_t m = (dim / 2) - 1;
    // We use PI / 2 instead of 2*PI to only sample from the positive orthant.
    for (dimension_t i = 0; i < m; i++) {
        int l = dim - 2*i - 2;
        ASSUME(l > 0);
        double tmp = pow(u[l-1], 1. / l);
        ASSUME(tmp <= 1.);
        double dl = sqrt(1. - tmp * tmp) * product;
        product *= tmp;
        double u_times_pi2 = M_PI_2 * u[l];
        w[2*i] = dl * sin(u_times_pi2);
        w[2*i + 1] = dl * cos(u_times_pi2);
    }

    double u_times_pi2;
    if (dim % 2 == 0) { // dim is even
        u_times_pi2 = M_PI_2 * u[0];
    } else  { // dim is odd
        w[dim - 3] = product * u[0];
        product *= sqrt(1 - u[0] * u[0]);
        u_times_pi2 = M_PI_2 * u[1];
    }
    w[dim - 2] = product * sin(u_times_pi2);
    w[dim - 1] = product * cos(u_times_pi2);
}
